...
const LanguageSelector = () => {
    return (
        <div className="flex items-center gap-1 sm:gap-2 border border-[#E2E4E9] rounded-lg px-2 py-1 w-full min-w-[100px] max-w-[179px] sm:w-[179px] h-[32px] -mt-[40px] mr-[135px]">
